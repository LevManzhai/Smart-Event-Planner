(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[235],{1295:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});var r=a(2898);/**
...
`,em=({reverseOrder:e,position:t="top-center",toastOptions:a,gutter:r,children:s,toasterId:i,containerStyle:n,containerClassName:l})=>{let{toasts:c,handlers:u}=H(a,i);return o.createElement("div",{"data-rht-toaster":i||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...n},className:l,onMouseEnter:u.startPause,onMouseLeave:u.endPause},c.map(a=>{let i=a.position||t,n=eu(i,u.calculateOffset(a,{reverseOrder:e,gutter:r,defaultPosition:t}));return o.createElement(ec,{id:a.id,key:a.id,onHeightUpdate:u.updateHeight,className:a.visible?ed:"",style:n},"custom"===a.type?k(a.message,a):s?s(a):o.createElement(el,{toast:a,position:i}))}))},ep=F}},function(e){e.O(0,[673,676,971,472,744],function(){return e(e.s=1494)}),_N_E=e.O()}]);